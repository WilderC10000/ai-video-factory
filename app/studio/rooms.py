...
ROOMS: list[Room] = [
    ...
    Room("sound_booth", "Sound Booth", "Sound Designer",
         "Source audio in generated clips; sound design (music, SFX, voice) later", 4, 2,
         "audio streams probed from generated clips (ffprobe)"),
